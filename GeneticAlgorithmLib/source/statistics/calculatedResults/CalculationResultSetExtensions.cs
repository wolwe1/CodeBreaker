...
namespace GeneticAlgorithmLib.source.statistics.calculatedResults
{
    public static class CalculationResultSetExtensions
    {
        ...
        /// <summary>
        /// Map each <see cref="CalculationResult"/> in the list to a new <see cref="CalculationResult"/> with a result equal to the return value of the function passed in
        /// </summary>
        ...
        public static IEnumerable<CalculationResultSet> Map(this IEnumerable<CalculationResultSet> list, CalculationResultExtensions.MapFunc function)
        {
        ...
        public static List<double> Accumulator(this IEnumerable<CalculationResultSet> list, CalculationResultExtensions.AccFunc function)
        {
